...
// Login
route.post('/api/signup', validateUser, authController.singUp)
route.post('/api/signin', authController.singIn)

// Rutas para el modelo User
route.post('/api/users', verifyToken, userController.createUser);
route.get('/api/users', verifyToken, userController.getUsers);
